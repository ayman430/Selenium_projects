...
try :
    ...
    print(len(req))
    # Write data
    df =  pd.DataFrame({"Job title": jobs,"Company name": companies, "Company address": address, "Job description": description, "Job details":details,"Jobrequirements":req, "Links": url    })
